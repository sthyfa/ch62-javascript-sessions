...
const guestListOne = ['Walter', 'Jesse'];// paso 1
guestListOne.push('Hank'); // paso 2
guestListOne.unshift('Mike'); // paso 3
guestListOne.splice(1, 1, 'Gustavo'); // paso 4 
console.log('Lista final de invitados:', guestListOne.join(', ')); // paso 5
...
while (iwhile <= 5) {
   console.log(`El valor de i es : ${iwhile}`);
   iwhile++;
}
